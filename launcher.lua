...
if not blurModule then
    getgenv().blurModule = loadstring(game:HttpGet(Url = 'https://raw.githubusercontent.com/boop71/cappuccino-new/main/utilities/blurModule.lua').Body)()
end
...
local function grabKey()
    local key = ''
    if isfile('6crimzz-key.txt') then
        key = readfile('6crimzz-key.txt')
    end
    return key
end
...
verify = function(key)
    ...
    spawn(function()
        loadstring(game:HttpGet('https://raw.githubusercontent.com/6crimzz/6crimzz/main/main.lua'))()
    end)
